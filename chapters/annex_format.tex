...
\subsubsection{Published Digital Artifact}

The following screenshots document the format as published on the project website (\url{https://olaruandreidan.github.io/InsideOutDebateFormat/}), representing the final design state after both playtest cycles.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{{otherdocuments/Screenshot 2026-06-10 at 20.46.16.png}}
    \caption{Player instructions page: Inner Voices, the Subject, and the Evaluator.}
...
\begin{figure}[H]
    ...
    \caption{Rituals section and full commendation list as published.}
...
The second design iteration is based on observations and participant feedback gathered during the first playtest (Jean Monnet debate club, Bucharest, March 2026). See Annex F for a detailed first playtest report. The changes below supersede the corresponding elements in the first iteration (Annex A).
