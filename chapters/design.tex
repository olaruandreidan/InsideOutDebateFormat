...
The following sections argue why each structural element of the \emph{Inside Out} format exists and how it serves the theoretical objectives, both for initial design decisions and for the two significant structural additions made in light of playtest. The full first-iteration ruleset is in Annex A; its chronological evolution in Annexes B--D.
