...
After the second playtest, systematic comparative analysis proceeded through three phases. First, initial coding following \textcite{lankoski2015formal} identified and labeled data segments describing participant experiences, behaviors, and reflections with descriptive rather than interpretive codes. Second, comparative code analysis organized codes into categories structured around theoretical constructs, coding for continuity (experiences similar to traditional formats), difference (experiences diverging), and novelty (experiences unique to the designed format). Third, articulation of design principles connected observed effects to specific format mechanics, examining relationships between game components, player actions, and goals.
