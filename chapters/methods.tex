...
The main purpose of the  pre-specified clue taxonomy is to maximize for a large breath of relevant insight derived from the playtesting and against potential cognitive tunneling and inattentional blindness that may surface due to the structural circularity of both authoring, facilitating and observing the game. It also favors noticing unexpected results and eases the process of theorycrafting their implications, as it explicits a-priori the mechanisms that ought to have but have not or have not solely been at play.
